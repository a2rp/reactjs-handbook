 ...
 */var Mu;function Mh(){if(Mu)return ne;Mu=1;var i=Symbol.for("react.element"),a=Symbol.for("react.portal"),c=Symbol.for("react.fragment"),d=Symbol.for("react.strict_mode"),m=Symbol.for("react.profiler"),w=Symbol.for("react.provider"),P=Symbol.for("react.context"),A=Symbol.for("react.forward_ref"),T=Symbol.for("react.suspense"),Q=Symbol.for("react.memo"),V=Symbol.for("react.lazy"),L=Symbol.iterator;function $(x){return x===null||typeof x!="object"?null:(x=L&&x[L]||x["@@iterator"],typeof x=="function"?x:null)}var G={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},se=Object.assign,W={};function J(x,k,q){this.props=x,this.context=k,this.refs=W,this.updater=q||G}J.prototype.isReactComponent={},J.prototype.setState=function(x,k){if(typeof x!="object"&&typeof x!="function"&&x!=null)throw Error("setState(...): takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,x,k,"setState")},J.prototype.forceUpdate=function(x){this.updater.enqueueForceUpdate(this,x,"forceUpdate")};function he(){}he.prototype=J.prototype;function ie(x,k,q){this.props=x,this.context=k,this.refs=W,this.updater=q||G}var le=ie.prototype=new he;le.constructor=ie,se(le,J.prototype),le.isPureReactComponent=!0;var Z=Array.isArray,de=Object.prototype.hasOwnProperty,K={current:null},B={key:!0,ref:!0,__self:!0,__source:!0};function Ne(x,k,q){var Y,re={},ee=null,fe=null;if(k!=null)for(Y in k.ref!==void 0&&(fe=k.ref),k.key!==void 0&&(ee=""+k.key),k)de.call(k,Y)&&!B.hasOwnProperty(Y)&&(re[Y]=k[Y]);var oe=arguments.length-2;if(oe===1)re.children=q;else if(1<oe){for(var ce=Array(oe),Me=0;Me<oe;Me++)ce[Me]=arguments[Me+2];re.children=ce}if(x&&x.defaultProps)for(Y in oe=x.defaultProps,oe)re[Y]===void 0&&(re[Y]=oe[Y]);return{$$typeof:i,type:x,key:ee,ref:fe,props:re,_owner:K.current}}function en(x,k){return{$$typeof:i,type:x.type,key:k,ref:x.ref,props:x.props,_owner:x._owner}}function xn(x){return typeof x=="object"&&x!==null&&x.$$typeof===i}function An(x){var k={"=":"=0",":":"=2"};return"$"+x.replace(/[=:]/g,function(q){return k[q]})}var an=/\/+/g;function Ve(x,k){return typeof x=="object"&&x!==null&&x.key!=null?An(""+x.key):k.toString(36)}function nn(x,k,q,Y,re){var ee=typeof x;(ee==="undefined"||ee==="boolean")&&(x=null);var fe=!1;if(x===null)fe=!0;else switch(ee){case"string":case"number":fe=!0;break;case"object":switch(x.$$typeof){case i:case a:fe=!0}}if(fe)return fe=x,re=re(fe),x=Y===""?"."+Ve(fe,0):Y,Z(re)?(q="",x!=null&&(q=x.replace(an,"$&/")+"/"),nn(re,k,q,"",function(Me){return Me})):re!=null&&(xn(re)&&(re=en(re,q+(!re.key||fe&&fe.key===re.key?"":(""+re.key).replace(an,"$&/")+"/")+x)),k.push(re)),1;if(fe=0,Y=Y===""?".":Y+":",Z(x))for(var oe=0;oe<x.length;oe++){ee=x[oe];var ce=Y+Ve(ee,oe);fe+=nn(ee,k,q,ce,re)}else if(ce=$(x),typeof ce=="function")for(x=ce.call(x),oe=0;!(ee=x.next()).done;)ee=ee.value,ce=Y+Ve(ee,oe++),fe+=nn(ee,k,q,ce,re);else if(ee==="object")throw k=String(x),Error("Objects are not valid as a React child (found: "+(k==="[object Object]"?"object with keys {"+Object.keys(x).join(", ")+"}":k)+"). If you meant to render a collection of children, use an array instead.");return fe}function cn(x,k,q){if(x==null)return x;var Y=[],re=0;return nn(x,Y,"","",function(ee){return k.call(q,ee,re++)}),Y}function $e(x){if(x._status===-1){var k=x._result;k=k(),k.then(function(q){(x._status===0||x._status===-1)&&(x._status=1,x._result=q)},function(q){(x._status===0||x._status===-1)&&(x._status=2,x._result=q)}),x._status===-1&&(x._status=0,x._result=k)}if(x._status===1)return x._result.default;throw x._result}var ge={current:null},N={transition:null},z={ReactCurrentDispatcher:ge,ReactCurrentBatchConfig:N,ReactCurrentOwner:K};function O(){throw Error("act(...) is not supported in production builds of React.")}return ne.Children={map:cn,forEach:function(x,k,q){cn(x,function(){k.apply(this,arguments)},q)},count:function(x){var k=0;return cn(x,function(){k++}),k},toArray:function(x){return cn(x,function(k){return k})||[]},only:function(x){if(!xn(x))throw Error("React.Children.only expected to receive a single React element child.");return x}},ne.Component=J,ne.Fragment=c,ne.Profiler=m,ne.PureComponent=ie,ne.StrictMode=d,ne.Suspense=T,ne.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED=z,ne.act=O,ne.cloneElement=function(x,k,q){if(x==null)throw Error("React.cloneElement(...): The argument must be a React element, but you passed "+x+".");var Y=se({},x.props),re=x.key,ee=x.ref,fe=x._owner;if(k!=null){if(k.ref!==void 0&&(ee=k.ref,fe=K.current),k.key!==void 0&&(re=""+k.key),x.type&&x.type.defaultProps)var oe=x.type.defaultProps;for(ce in k)de.call(k,ce)&&!B.hasOwnProperty(ce)&&(Y[ce]=k[ce]===void 0&&oe!==void 0?oe[ce]:k[ce])}var ce=arguments.length-2;if(ce===1)Y.children=q;else if(1<ce){oe=Array(ce);for(var Me=0;Me<ce;Me++)oe[Me]=arguments[Me+2];Y.children=oe}return{$$typeof:i,type:x.type,key:re,ref:ee,props:Y,_owner:fe}},ne.createContext=function(x){return x={$$typeof:P,_currentValue:x,_currentValue2:x,_threadCount:0,Provider:null,Consumer:null,_defaultValue:null,_globalName:null},x.Provider={$$typeof:w,_context:x},x.Consumer=x},ne.createElement=Ne,ne.createFactory=function(x){var k=Ne.bind(null,x);return k.type=x,k},ne.createRef=function(){return{current:null}},ne.forwardRef=function(x){return{$$typeof:A,render:x}},ne.isValidElement=xn,ne.lazy=function(x){return{$$typeof:V,_payload:{_status:-1,_result:x},_init:$e}},ne.memo=function(x,k){return{$$typeof:Q,type:x,compare:k===void 0?null:k}},ne.startTransition=function(x){var k=N.transition;N.transition={};try{x()}finally{N.transition=k}},ne.unstable_act=O,ne.useCallback=function(x,k){return ge.current.useCallback(x,k)},ne.useContext=function(x){return ge.current.useContext(x)},ne.useDebugValue=function(){},ne.useDeferredValue=function(x){return ge.current.useDeferredValue(x)},ne.useEffect=function(x,k){return ge.current.useEffect(x,k)},ne.useId=function(){return ge.current.useId()},ne.useImperativeHandle=function(x,k,q){return ge.current.useImperativeHandle(x,k,q)},ne.useInsertionEffect=function(x,k){return ge.current.useInsertionEffect(x,k)},ne.useLayoutEffect=function(x,k){return ge.current.useLayoutEffect(x,k)},ne.useMemo=function(x,k){return ge.current.useMemo(x,k)},ne.useReducer=function(x,k,q){return ge.current.useReducer(x,k,q)},ne.useRef=function(x){return ge.current.useRef(x)},ne.useState=function(x){return ge.current.useState(x)},ne.useSyncExternalStore=function(x,k,q){return ge.current.useSyncExternalStore(x,k,q)},ne.useTransition=function(){return ge.current.useTransition()},ne.version="18.3.1",ne}var zu;function Mi(){return zu||(zu=1,ji.exports=Mh()),ji.exports}/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Lu;function zh(){if(Lu)return Wr;Lu=1;var i=Mi(),a=Symbol.for("react.element"),c=Symbol.for("react.fragment"),d=Object.prototype.hasOwnProperty,m=i.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner,w={key:!0,ref:!0,__self:!0,__source:!0};function P(A,T,Q){var V,L={},$=null,G=null;Q!==void 0&&($=""+Q),T.key!==void 0&&($=""+T.key),T.ref!==void 0&&(G=T.ref);for(V in T)d.call(T,V)&&!w.hasOwnProperty(V)&&(L[V]=T[V]);if(A&&A.defaultProps)for(V in T=A.defaultProps,T)L[V]===void 0&&(L[V]=T[V]);return{$$typeof:a,type:A,key:$,ref:G,props:L,_owner:m.current}}return Wr.Fragment=c,Wr.jsx=P,Wr.jsxs=P,Wr}var $u;function Lh(){return $u||($u=1,vi.exports=zh()),vi.exports}var r=Lh(),zi=Mi();const te=Dh(zi);var ol={},wi={exports:{}},Xe={},ki={exports:{}},Si={};/**
 * @license React
...
clearTimeout(t);`}),r.jsxs("h3",{children:["B) ",r.jsx("code",{children:"setInterval"})," (repeating) + clear"]}),r.jsx(f.Code,{children:`let count = 0;
const iv = setInterval(() => {
  count++;
  console.log("tick", count);
  // "tick 1", "tick 2", "tick 3"
  if (count === 3) clearInterval(iv); // stops after 3
}, 100);`}),r.jsxs("h3",{children:["C) Drift & accuracy: ",r.jsx("em",{children:"recursive"})," timeout over interval"]}),r.jsxs("p",{children:["Long callbacks cause ",r.jsx("code",{children:"setInterval"})," to drift. Prefer scheduling the next run yourself (recursive ",r.jsx("code",{children:"setTimeout"}),") and adjust with timestamps."]}),r.jsx(f.Code,{children:`const stepMs = 100;
...
// logs small drift values, auto-correcting each step`}),r.jsx("h3",{children:"D) Debounce (wait for quiet period) & Throttle (limit rate)"}),r.jsx(f.Code,{children:`// Debounce: call after N ms of inactivity
...
log(1); log(2); log(3); // "debounced 3" (only last call runs)`}),r.jsxs("h3",{children:["E) Promise-based sleep + ",r.jsx("code",{children:"async/await"})]}),r.jsx(f.Code,{children:`const sleep = (ms) => new Promise(r => setTimeout(r, ms));
...
})();`}),r.jsx("h3",{children:"F) Next tick & animation"}),r.jsx(f.Code,{children:`// Next microtask (before timeouts)
Promise.resolve().then(() => console.log("microtask"));
// Next animation frame (~60fps)
requestAnimationFrame(() => console.log("raf"));`}),r.jsx("h3",{children:"G) React patterns — effects + cleanup"}),r.jsx(f.Code,{children:`// 1) One-shot timeout on mount with cleanup
// React.useEffect(() => {
//   const id = setTimeout(() => {
//     // setState("ready")
//   }, 300);
...
// }`}),r.jsx("h3",{children:"H) Node vs Browser (notes)"}),r.jsxs("ul",{children:[r.jsxs("li",{children:["Browsers may ",r.jsx("strong",{children:"throttle"})," timers in background tabs (e.g., clamped to ~1000ms)."]}),r.jsxs("li",{children:["Node also has ",r.jsx("code",{children:"setImmediate"})," and ",r.jsx("code",{children:"process.nextTick"})," (microtask); timers API is otherwise similar."]})]}),r.jsx("h3",{children:"I) Pitfalls & tips"}),r.jsxs("ul",{children:[r.jsxs("li",{children:[r.jsx("strong",{children:"Always clear"})," timeouts/intervals you create (especially in React effects)."]}),r.jsxs("li",{children:[r.jsx("strong",{children:"Don't rely on exact ms."})," Timers run “as soon as possible” after the delay."]}),r.jsxs("li",{children:[r.jsx("strong",{children:"Avoid piling work in intervals."})," If work may take longer than the interval, prefer recursive timeouts with drift correction."]}),r.jsxs("li",{children:[r.jsx("strong",{children:"Debounce for bursts"})," (search input), ",r.jsx("strong",{children:"throttle for steady rate"})," (scroll/resize)."]})]}),r.jsx("h3",{children:"Mini-checklist"}),r.jsxs("ul",{children:[r.jsxs("li",{children:["Use ",r.jsx("code",{children:"setTimeout"})," for one-shot; ",r.jsx("code",{children:"setInterval"})," for repeats (but watch drift)."]}),r.jsx("li",{children:"Keep ids; clear them on unmount or when no longer needed."}),r.jsxs("li",{children:["Use ",r.jsx("code",{children:"sleep()"})," for readable async flows; pair timers with ",r.jsx("code",{children:"Promise"}),"s."]}),r.jsx("li",{children:"Prefer debounce/throttle for high-frequency events."})]}),r.jsx(f.Divider,{})]})}function Fm(){return r.jsxs(Um.Wrapper,{children:[r.jsx("h1",{children:"ReactJS Handbook"}),r.jsxs("fieldset",{style:{padding:"0 15px 15px 30px",marginBottom:15},children:[r.jsx("legend",{style:{padding:15},children:"From Wikipedia - last updated: Sep 02, 2025"}),r.jsx("p",{children:'React (also known as React.js or ReactJS) is a free and open-source front-end JavaScript library that aims to make building user interfaces based on components more "seamless". It is maintained by Meta (formerly Facebook) and a community of individual developers and companies.'}),r.jsx("br",{}),r.jsx("p",{children:"React can be used to develop single-page, mobile, or server-rendered applications with frameworks like Next.js and Remix. Because React is only concerned with the user interface and rendering components to the DOM, React applications often rely on libraries for routing and other client-side functionality. A key advantage of React is that it only re-renders those parts of the page that have changed, avoiding unnecessary re-rendering of unchanged DOM elements."})]}),r.jsx("h1",{style:{marginTop:"30px"},children:"My Notes"}),r.jsx("h3",{children:"last updated: Sep 02, 2025"}),r.jsx("div",{className:"divider"}),r.jsx("h3",{children:"0. Setup & Local Dev"}),r.jsxs(r.Fragment,{children:[r.jsx(Qp,{}),r.jsx(Kp,{}),r.jsx(Xp,{}),r.jsx(em,{}),r.jsx(tm,{}),r.jsx(sm,{})]}),r.jsx("h3",{style:{marginTop:50},children:"1. ES6+ I actually use daily"}),r.jsxs(r.Fragment,{children:[r.jsx(om,{}),r.jsx(am,{}),r.jsx(um,{}),r.jsx(fm,{}),r.jsx(pm,{}),r.jsx(gm,{}),r.jsx(ym,{}),r.jsx(jm,{}),r.jsx(km,{}),r.jsx(Cm,{}),r.jsx(Pm,{}),r.jsx(Tm,{}),r.jsx(Om,{}),r.jsx(Rm,{}),r.jsx(Am,{}),r.jsx(Mm,{}),r.jsx(Lm,{})]})]})}const Um={Wrapper:Pn.div`
    --bg: #0d0f14;
    --text: #e5e7eb;
    min-height: 100vh;
    background: var(--bg);
  ...
  `};var Md={color:void 0,size:void 0,className:void 0,style:void 0,attr:void 0},id=te.createContext&&te.createContext(Md),Bm=["attr","size","title"];function Hm(i,a){if(i==null)return{};var c=Vm(i,a),d,m;if(Object.getOwnPropertySymbols){var w=Object.getOwnPropertySymbols(i);for(m=0;m<w.length;m++)d=w[m],!(a.indexOf(d)>=0)&&Object.prototype.propertyIsEnumerable.call(i,d)&&(c[d]=i[d])}return c}function Vm(i,a){if(i==null)return{};var c={};for(var d in i)if(Object.prototype.hasOwnProperty.call(i,d)){if(a.indexOf(d)>=0)continue;c[d]=i[d]}return c}function xl(){return xl=Object.assign?Object.assign.bind():function(i){for(var a=1;a<arguments.length;a++){var c=arguments[a];for(var d in c)Object.prototype.hasOwnProperty.call(c,d)&&(i[d]=c[d])}return i},xl.apply(this,arguments)}function ad(i,a){var c=Object.keys(i);if(Object.getOwnPropertySymbols){var d=Object.getOwnPropertySymbols(i);a&&(d=d.filter(function(m){return Object.getOwnPropertyDescriptor(i,m).enumerable})),c.push.apply(c,d)}return c}function yl(i){for(var a=1;a<arguments.length;a++){var c=arguments[a]!=null?arguments[a]:{};a%2?ad(Object(c),!0).forEach(function(d){Wm(i,d,c[d])}):Object.getOwnPropertyDescriptors?Object.defineProperties(i,Object.getOwnPropertyDescriptors(c)):ad(Object(c)).forEach(function(d){Object.defineProperty(i,d,Object.getOwnPropertyDescriptor(c,d))})}return i}function Wm(i,a,c){return a=Qm(a),a in i?Object.defineProperty(i,a,{value:c,enumerable:!0,configurable:!0,writable:!0}):i[a]=c,i}function Qm(i){var a=Gm(i,"string");return typeof a=="symbol"?a:a+""}function Gm(i,a){if(typeof i!="object"||!i)return i;var c=i[Symbol.toPrimitive];if(c!==void 0){var d=c.call(i,a);if(typeof d!="object")return d;throw new TypeError("@@toPrimitive must return a primitive value.")}return(a==="string"?String:Number)(i)}function zd(i){return i&&i.map((a,c)=>te.createElement(a.tag,yl({key:c},a.attr),zd(a.child)))}function Km(i){return a=>te.createElement(qm,xl({attr:yl({},i.attr)},a),zd(i.child))}function qm(i){var a=c=>{var{attr:d,size:m,title:w}=i,P=Hm(i,Bm),A=m||c.size||"1em",T;return c.className&&(T=c.className),i.className&&(T=(T?T+" ":"")+i.className),te.createElement("svg",xl({stroke:"currentColor",fill:"currentColor",strokeWidth:"0"},c.attr,d,P,{className:T,style:yl(yl({color:i.color||c.color},c.style),i.style),height:A,width:A,xmlns:"http://www.w3.org/2000/svg"}),w&&te.createElement("title",null,w),i.children)};return id!==void 0?te.createElement(id.Consumer,null,c=>a(c)):a(Md)}function Jm(i){return Km({attr:{viewBox:"0 0 320 512"},child:[{tag:"path",attr:{d:"M177 255.7l136 136c9.4 9.4 9.4 24.6 0 33.9l-22.6 22.6c-9.4 9.4-24.6 9.4-33.9 0L160 351.9l-96.4 96.4c-9.4 9.4-24.6 9.4-33.9 0L7 425.7c-9.4-9.4-9.4-24.6 0-33.9l136-136c9.4-9.5 24.6-9.5 34-.1zm-34-192L7 199.7c-9.4 9.4-9.4 24.6 0 33.9l22.6 22.6c9.4 9.4 24.6 9.4 33.9 0l96.4-96.4 96.4 96.4c9.4 9.4 24.6 9.4 33.9 0l22.6-22.6c9.4-9.4 9.4-24.6 0-33.9l-136-136c-9.2-9.4-24.4-9.4-33.8 0z"},child:[]}]})(i)}function Ym({threshold:i=50}){const[a,c]=te.useState(!1),d=te.useMemo(()=>{var w,P;return(P=(w=window.matchMedia)==null?void 0:w.call(window,"(prefers-reduced-motion: reduce)"))==null?void 0:P.matches},[]);te.useEffect(()=>{let w=!1;const P=()=>{w||(window.requestAnimationFrame(()=>{c(window.scrollY>i),w=!1}),w=!0)};return P(),window.addEventListener("scroll",P,{passive:!0}),()=>window.removeEventListener("scroll",P)},[i]);const m=()=>{window.scrollTo({top:0,behavior:d?"auto":"smooth"})};return r.jsx(Xm,{type:"button","aria-label":"Scroll to top",onClick:m,"data-visible":a,title:"Back to top",children:r.jsx(Jm,{})})}const Xm=Pn.button`
    position: fixed;
    right: 18px;
    bottom: 18px;
    width: 44px;
...
`,Zm=()=>r.jsxs(r.Fragment,{children:[r.jsx(Fm,{}),r.jsx(Ym,{})]});Vh.createRoot(document.getElementById("root")).render(r.jsx(r.Fragment,{children:r.jsx(Zm,{})}));
